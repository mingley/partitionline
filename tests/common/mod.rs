...
use partitionline::protocol::admin::{
    ...
    encode_delete_groups_response, encode_delete_records_response, encode_delete_topics_response,
    ...
    DescribedConsumerGroup, DescribedGroup, DescribedShareGroup, ListGroupsResponse,
