...
pub struct ConsumerMetrics {
    ...
    /// Successful [`crate::Consumer::offsets_for_times`] batch calls.
    /// KL-07 diagnosis: timestamp→offset lookup health without dumping payloads.
    pub offsets_for_times_ok: u64,
    /// Failed [`crate::Consumer::offsets_for_times`] batch calls (validation or terminal RPC).
    pub offsets_for_times_fail: u64,
}
...
mod tests {
    ...
    fn metrics_default_zero() {
        ...
        assert_eq!(ConsumerMetrics::default().offsets_for_times_ok, 0);
        assert_eq!(ConsumerMetrics::default().offsets_for_times_fail, 0);
