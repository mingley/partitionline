...
pub struct ProducerMetrics {
    ...
    /// Sum of broker `throttle_time_ms` from Produce responses (KL-07 diagnosis).
    pub broker_throttle_ms_total: u64,
...
pub struct ConsumerMetrics {
    ...
    /// Sum of broker `throttle_time_ms` from Fetch responses (KL-07 diagnosis).
    pub broker_throttle_ms_total: u64,
...
mod tests {
    ...
    fn metrics_default_zero() {
        ...
        assert_eq!(ProducerMetrics::default().broker_throttle_ms_total, 0);
        ...
        assert_eq!(ConsumerMetrics::default().broker_throttle_ms_total, 0);
