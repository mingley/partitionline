...
pub struct Consumer {
    ...
    m_bytes: AtomicU64,
    m_errors: AtomicU64,
    m_offset_commit_ok: AtomicU64,
    m_offset_commit_fail: AtomicU64,
...
impl Consumer {
    ...
    pub async fn new(cfg: ConsumerConfig) -> Result<Self> {
        ...
        Ok(Self {
            ...
            m_offset_commit_ok: AtomicU64::new(0),
            m_offset_commit_fail: AtomicU64::new(0),
    ...
    pub fn metrics(&self) -> crate::ConsumerMetrics {
        crate::ConsumerMetrics {
            ...
            offset_commit_ok: self.m_offset_commit_ok.load(Ordering::Relaxed),
            offset_commit_fail: self.m_offset_commit_fail.load(Ordering::Relaxed),
        }
    }

    pub(crate) fn record_offset_commit_ok(&self) {
        let _ = self.m_offset_commit_ok.fetch_add(1, Ordering::Relaxed);
    }

    pub(crate) fn record_offset_commit_fail(&self) {
        let _ = self.m_offset_commit_fail.fetch_add(1, Ordering::Relaxed);
    }
