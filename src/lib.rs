...
//! AlterPartitionReassignments, DescribeCluster).
...
pub use admin::{
    ...
    NewTopic, OffsetDeleteResult, PartitionReassignment, ReassignmentResult, ALTER_CONFIG_DELETE,
    ALTER_CONFIG_SET, CONFIG_RESOURCE_BROKER, CONFIG_RESOURCE_TOPIC,
};
