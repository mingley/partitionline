...
async fn main() -> partitionline::Result<()> {
    ...
    if format == "prom" {
        ...
        println!("# HELP partitionline_list_offsets_ok ListOffsets successes");
        println!("# TYPE partitionline_list_offsets_ok counter");
        println!("partitionline_list_offsets_ok {}", cm.list_offsets_ok);
        println!("# HELP partitionline_list_offsets_fail ListOffsets failures");
        println!("# TYPE partitionline_list_offsets_fail counter");
        println!("partitionline_list_offsets_fail {}", cm.list_offsets_fail);
        ...
        println!(
            "fetched {} records rounds={} bytes={} errors={} list_offsets_ok={} list_offsets_fail={} fetch_us={} p50_us={} p99_us={} topics={}",
            recs.len(),
            cm.fetch_rounds,
            cm.bytes_fetched,
            cm.fetch_errors,
            cm.list_offsets_ok,
            cm.list_offsets_fail,
