...
async fn main() -> partitionline::Result<()> {
    ...
    if format == "prom" {
        ...
        println!("# HELP partitionline_offset_commit_ok OffsetCommit successes");
        println!("# TYPE partitionline_offset_commit_ok counter");
        println!("partitionline_offset_commit_ok {}", cm.offset_commit_ok);
        println!("# HELP partitionline_offset_commit_fail OffsetCommit failures");
        println!("# TYPE partitionline_offset_commit_fail counter");
        println!("partitionline_offset_commit_fail {}", cm.offset_commit_fail);
        ...
        println!(
            "fetched {} records rounds={} bytes={} errors={} commit_ok={} commit_fail={} fetch_us={} p50_us={} p99_us={} topics={}",
            recs.len(),
            cm.fetch_rounds,
            cm.bytes_fetched,
            cm.fetch_errors,
            cm.offset_commit_ok,
            cm.offset_commit_fail,
