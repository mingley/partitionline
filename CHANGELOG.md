...
- Kafka 3.9 `ConsumerGroupHeartbeat`: truncated preview frames (correlation-id-only header, empty body, or throttle-plus-error-code) are `Unsupported` instead of `protocol: need 1 bytes, have 0`.
