...
ElectLeaders / DescribeLogDirs v5 / raft voters stay closed. DescribeQuorum
(55) is spoken in this tree (`Admin::describe_metadata_quorum`); the unsigned
fetch writeup did not exercise it.
...
No new admin API in that measurement. ElectLeaders / DescribeLogDirs v5 /
raft voters stay closed. DescribeQuorum (55) is spoken in this tree
(`Admin::describe_metadata_quorum`); the unsigned latency writeup did not
exercise it.
