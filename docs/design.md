...
- ListOffsets v4+ has `current_leader_epoch` before timestamp. The v4+ response has `leader_epoch` after offset. v1–v5 are classic; v6–v9 are flexible (compact arrays/strings plus tagged fields; request header 2, response header 1). v7 is MAX_TIMESTAMP `-3` (KIP-734). v8 is EARLIEST_LOCAL `-4` (KIP-405). v9 is LATEST_TIERED `-5` (KIP-1005). Kafka 4.0 `validVersions` is `1-10`. This crate speaks 1–9. v10 `TimeoutMs` (KIP-1075) is not spoken.
