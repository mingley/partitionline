...
Named gaps stay closed: ElectLeaders (43), DescribeLogDirs v5, Add/Remove/UpdateRaftVoter (80–82).
DescribeQuorum (55) is spoken (v0–2; `Admin::describe_metadata_quorum`).
