...
**KL-07 heartbeat diagnosis Partial (2026-09-05, tip `c37c78c`):** `ConsumerMetrics::heartbeat_ok` / `heartbeat_fail` count classic Heartbeat and ConsumerGroupHeartbeat outcomes; guide cookbook + `tests/heartbeat_metrics.rs`. Does **not** close full KL-07. Does **not** lift Suite HOLD.
