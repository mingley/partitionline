...
**KL-07 ApiVersions diagnosis Partial (2026-09-05, tip `PENDING`):** `ConsumerMetrics::api_versions_ok` / `api_versions_fail` count terminal ApiVersions outcomes; guide cookbook + `tests/api_versions_metrics.rs`. Does **not** close full KL-07. Does **not** lift Suite HOLD.
