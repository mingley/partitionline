...
**KL-08 promotion/rollback exercise template (2026-09-05, tip `"f0f65d3"`):** `docs/promotion-rollback-exercise.md` is the blank traffic-shadow + operator-approved rollback record format (`UNFILLED — not evidence`); linked from support.md + ADOPTION.md + ROADMAP. Does **not** close full KL-08 (no filled shadow/rollback proof). Does **not** lift Suite HOLD.
