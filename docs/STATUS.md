...
**KL-07 FindCoordinator diagnosis Partial (2026-09-05, tip `32f04de`):** `ConsumerMetrics::find_coordinator_ok` / `find_coordinator_fail` count terminal FindCoordinator discoveries; guide cookbook + `tests/find_coordinator_metrics.rs`. Does **not** close full KL-07. Does **not** lift Suite HOLD.
