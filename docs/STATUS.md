...
**KL-07 join/sync diagnosis Partial (2026-09-05, tip `PENDING`):** `ConsumerMetrics::join_ok` / `join_fail` / `sync_ok` / `sync_fail` count classic JoinGroup/SyncGroup outcomes; guide cookbook + `tests/join_sync_metrics.rs`. Does **not** close full KL-07. Does **not** lift Suite HOLD.
