...
**KL-07 OffsetFetch diagnosis Partial (2026-09-05, tip `d14df1b`):** `ConsumerMetrics::offset_fetch_ok` / `offset_fetch_fail` count terminal OffsetFetch outcomes; guide cookbook + `tests/offset_fetch_metrics.rs`. Does **not** close full KL-07. Does **not** lift Suite HOLD.
