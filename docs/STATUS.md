...
**Native Verifiable recheck (2026-09-04, tip ):** native Kafka 4.1 broker-smoke (kip848+share) green;  auth-smoke SASL_SSL PLAIN+SCRAM-256/512+OAUTHBEARER+OIDC+mTLS fail-closed green; Lab A integrity COUNT=2000 HW==acked and consumed==seeded green; latency gate quiet p99≈220µs (pass vs 750µs) after under-agent-load miss ≈837µs; fuzz decode smoke green — still **unsigned**, still not a Suite HOLD lift. 
