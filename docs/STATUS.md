...
**KL-07 Metadata refresh diagnosis Partial (2026-09-05, tip `988e569`):** `ConsumerMetrics::metadata_refresh_ok` / `metadata_refresh_fail` count terminal Metadata refreshes; guide cookbook + `tests/metadata_refresh_metrics.rs`. Does **not** close full KL-07. Does **not** lift Suite HOLD.
