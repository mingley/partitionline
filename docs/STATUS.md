...
**KL-07 wakeup diagnosis Partial (2026-09-05, tip `75ed2c5`):** `ConsumerMetrics::wakeups_signaled` / `wakeups_consumed` count interrupt signals and drains; guide cookbook + `tests/wakeup_metrics.rs`. Does **not** close full KL-07. Does **not** lift Suite HOLD.
