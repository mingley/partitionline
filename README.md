...
`Admin::new` does not require ListConfigResources, GetTelemetrySubscriptions, PushTelemetry, AssignReplicasToDirs, UnregisterBroker, DescribeProducers, DescribeCluster, or UpdateFeatures.
