...
echo
echo "== check-cut-path: auth examples as packed-crate consumers =="
...
# Finish stashes day1 README/ADOPTION/guide/migrate before parks land; backup must restore if pop fails.
