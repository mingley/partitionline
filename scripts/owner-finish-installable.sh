...
echo "  git fetch origin && git checkout dev/verifiable-auth-integrity-fuzz-b686"
echo "  # Actions auth-smoke + integrity-smoke + ConsumerGroupHeartbeat fuzz — merge via PR to main after cut"
