...
echo "  # Preferred one-shot re-entry (TP + parks + full bars; Actions-alternate safe):"
...
echo "  DRY_RUN=1 bash scripts/owner-post-installable-handoff.sh"
echo "  # day1 flips README/ADOPTION/guide/migrate via post-publish-*.sh (DRY_RUN=1 preflight in publish-ready)"
echo "  # commit README + docs/ADOPTION.md + docs/guide.md + docs/migrate-from-rdkafka.md if day1 changed them"
